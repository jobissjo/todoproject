...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': [('authentication_add_user', 'Can add user'), ('authentication_change_user', 'Can change user'), ('authentication_delete_user', 'Can delete user'), ('authentication_view_user', 'Can view user')],
            },
            managers=[
